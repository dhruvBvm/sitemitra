...
- Name: auth.spec.js >> 1. Authentication >> Owner login with valid credentials -> redirects to /owner/dashboard
...
Expected pattern: /\/owner\/dashboard/
