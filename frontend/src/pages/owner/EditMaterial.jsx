...
export default function EditMaterial() {
  ...
  return (
    <div className="flex flex-col min-h-screen space-y-4 max-w-[428px] mx-auto pb-4 pt-1 bg-gray-50">
      {/* Sticky Header */}
      ...
      <div className="px-4">
        <form onSubmit={handleSubmit(onSubmit)} className="flex-1 w-full pb-6">
