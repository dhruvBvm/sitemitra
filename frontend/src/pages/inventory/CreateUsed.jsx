                        ...
                        <div className="flex flex-wrap gap-2 mt-3 w-full">
                          {materialImages[field.id].map((url, i) => (
                            <div key={i} className="relative w-16 h-16 rounded-md border border-gray-200 shrink-0 overflow-hidden">
                              <img src={url} alt="material" className="w-full h-full object-cover cursor-pointer" onClick={() => setCarouselModal({ isOpen: true, images: materialImages[field.id], index: i })} />
